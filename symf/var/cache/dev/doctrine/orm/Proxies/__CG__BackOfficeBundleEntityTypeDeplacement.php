 ...
 */
class TypeDeplacement extends \BackOfficeBundle\Entity\TypeDeplacement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\TypeDeplacement' . "\0" . 'typeDeplacement', '' . "\0" . 'BackOfficeBundle\\Entity\\TypeDeplacement' . "\0" . 'montant', '' . "\0" . 'BackOfficeBundle\\Entity\\TypeDeplacement' . "\0" . 'created', '' . "\0" . 'BackOfficeBundle\\Entity\\TypeDeplacement' . "\0" . 'updated', '' . "\0" . 'BackOfficeBundle\\Entity\\TypeDeplacement' . "\0" . 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeDeplacement $proxy) {
