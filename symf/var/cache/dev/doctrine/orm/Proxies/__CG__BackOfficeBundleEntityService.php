 ...
 */
class Service extends \BackOfficeBundle\Entity\Service implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Service' . "\0" . 'service', '' . "\0" . 'BackOfficeBundle\\Entity\\Service' . "\0" . 'id'];
        }
