 ...
 */
class TypeUser extends \BackOfficeBundle\Entity\TypeUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\TypeUser' . "\0" . 'typeUser', '' . "\0" . 'BackOfficeBundle\\Entity\\TypeUser' . "\0" . 'id'];
        }
