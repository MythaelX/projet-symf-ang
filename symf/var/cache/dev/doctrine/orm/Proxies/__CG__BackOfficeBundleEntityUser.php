...
class User extends \BackOfficeBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'BackOfficeBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'BackOfficeBundle\\Entity\\User' . "\0" . 'adresse', '' . "\0" . 'BackOfficeBundle\\Entity\\User' . "\0" . 'distanceInit', '' . "\0" . 'BackOfficeBundle\\Entity\\User' . "\0" . 'created', '' . "\0" . 'BackOfficeBundle\\Entity\\User' . "\0" . 'updated', '' . "\0" . 'BackOfficeBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\User' . "\0" . 'service', '' . "\0" . 'BackOfficeBundle\\Entity\\User' . "\0" . 'societe', '' . "\0" . 'BackOfficeBundle\\Entity\\User' . "\0" . 'typeUser', '' . "\0" . 'BackOfficeBundle\\Entity\\User' . "\0" . 'ville'];
        }
