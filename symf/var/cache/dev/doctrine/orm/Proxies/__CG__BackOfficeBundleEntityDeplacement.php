 ...
 */
class Deplacement extends \BackOfficeBundle\Entity\Deplacement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Deplacement' . "\0" . 'annee', '' . "\0" . 'BackOfficeBundle\\Entity\\Deplacement' . "\0" . 'mois', '' . "\0" . 'BackOfficeBundle\\Entity\\Deplacement' . "\0" . 'dateValidation', '' . "\0" . 'BackOfficeBundle\\Entity\\Deplacement' . "\0" . 'created', '' . "\0" . 'BackOfficeBundle\\Entity\\Deplacement' . "\0" . 'updated', '' . "\0" . 'BackOfficeBundle\\Entity\\Deplacement' . "\0" . 'validation', '' . "\0" . 'BackOfficeBundle\\Entity\\Deplacement' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\Deplacement' . "\0" . 'user', '' . "\0" . 'BackOfficeBundle\\Entity\\Deplacement' . "\0" . 'user1'];
        }
